...
:::info
Release V0.6.0 includes breaking changes, so here is the default configuration. You might have to restore it.
:::
...
**What to do with that JSON ?**

It must be the content of the `data.json` in your `.obsidian/plugins/findoc/data.json`
